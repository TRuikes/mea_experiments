...
#%%  Read repetition frequency files
# Read frep files
...
#%% Count the peaks for each dutcy_cycle / laser level file
...
coefs = dict(
    fr_slope_slope=fr_slope_slope,
    fr_slope_intercept=fr_slope_intercept,
    fr_inter_slope=fr_inter_slope,
    fr_inter_intercept=fr_inter_intercept,
)

df = pd.DataFrame.from_dict(coefs, orient='index')
df.to_csv('repetition_freq_coefs.csv')
