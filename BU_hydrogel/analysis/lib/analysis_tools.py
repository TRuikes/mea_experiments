...
params_per_protocol = {
    ...
    'bu_stim1': ['laser_pulse_repetition_rate', 'laser_power', 'laser_burst_duration'],
...
def get_params_protocol(protocol_name):
    ...
    elif 'dmd_fullfield' in protocol_name or 'dmd_full_field' in protocol_name:
        return params_per_protocol['dmd_fullfield']

    elif 'bu_stim_low' in protocol_name or 'bu_stim_high' in protocol_name:
        return params_per_protocol['bu_stim1']
