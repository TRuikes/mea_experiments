...
dataset_sessions = {
    ...
    # '2026-03-25 mouse c57 617 Mekano6 B': dict(skip_triggers=[]),  # data on pc work need to redo
    ...
    # '2026-05-06 mouse c57 611 MscL A': dict(skip_triggers=[1]),  # data on pc work, need to redo
    ...
    '2026-06-16 mouse c57 645 Mekano6 B': dict(skip_triggers=[1], laser_trigger_channel=255, dmd_trigger_channel=128)
