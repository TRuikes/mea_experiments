...
def main():
    # Load session data
    sid = '2026-08-26 mouse c57 755 eMSCL B'
    data_io = get_dataio()
    ...
    # Plot graphs
    ref_rec = 'rec_3_B_20260826_pa_dmd_timing_full_field'
    ...
    for cid in data_io.cluster_ids:
        ...
        if pd.isna(ec):
            ...
            has_pa = True
            pa_trials = data_io.train_df.query(f'rec_id == "rec_3_B_20260826_pa_dmd_timing_full_field" and '
                                               f'electrode == {ec} and '
                                               f'has_laser == 1 and '
                                               f'has_dmd == 0 and '
        ...
        dmd_trials = data_io.train_df.query(f'rec_id == "rec_3_B_20260826_pa_dmd_timing_full_field" and '
                                           f'has_laser == 0 and '
                                           f'has_dmd == 1')
        ...
        if has_pa:
            dual_trials = data_io.train_df.query(f'rec_id == "rec_3_B_20260826_pa_dmd_timing_full_field" and '
                                               f'electrode == {ec} and '
                                               f'has_laser == 1 and '
                                               f'has_dmd == 1 and '
