    ...
    for sid in session_ids:
        ...
        for r in data_io.recording_ids:
            if 'pa_dmd_timing' in r:
                ...
                found_dual = True
                break
        assert found_pa and found_dmd and found_dual
        ...
        for cid in tqdm(data_io.cluster_ids):
            ...
            if pd.isna(ec):
                ...
                has_pa = True
                pa_trials = data_io.train_df.query(f'rec_id == "{rids[0]}" and '
                                                   f'electrode == {ec} and '
                                                   f'has_laser == 1 and '
                                                   f'has_dmd == 0')
            ...
            dmd_trials = data_io.train_df.query(f'rec_id == "{rids[1]}" and '
                                               f'has_laser == 0 and '
                                               f'has_dmd == 1')
            ...
            if has_pa:
                tmp = data_io.train_df.query(f'rec_id == "{rids[2]}" and '
                                                     f'electrode == {ec} and '
                                                     f'has_laser == 1 and '
                                                     f'has_dmd == 1 and '
                                                     f'dmd_onset_delay == 0'
                ...
                dual_trials = data_io.train_df.query(f'rec_id == "{rids[2]}" and '
                                                   f'electrode == {ec} and '
                                                   f'has_laser == 1 and '
                                                   f'has_dmd == 1 and '
