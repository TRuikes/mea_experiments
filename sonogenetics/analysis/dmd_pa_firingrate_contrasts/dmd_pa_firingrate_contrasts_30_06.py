...
def main():
    # Load session data
    sid = '2026-06-30 rat LE 803 Mekano6 A'
    data_io = get_dataio()
    ...
    # Plot graphs
    ref_rec = 'rec_4_A_20260630_pa_dmd_timing'
    ...
    for cid in data_io.cluster_ids:
        ...
        if pd.isna(ec):
            ...
            has_pa = True
            pa_trials = data_io.train_df.query(f'rec_id == "rec_2_A_20260630_pa_intensity_test" and '
                                               f'electrode == {ec} and '
                                               f'has_laser == 1 and '
                                               f'has_dmd == 0'
                                               )
        ...
        dmd_trials = data_io.train_df.query(f'rec_id == "rec_5_A_20260630_dmd_full_field_intensities" and '
                                           f'has_laser == 0 and '
                                           f'has_dmd == 1')
        ...
        if has_pa:
            dual_trials = data_io.train_df.query(f'rec_id == "rec_4_A_20260630_pa_dmd_timing" and '
                                               f'electrode == {ec} and '
                                               f'has_laser == 1 and '
                                               f'has_dmd == 1 and '
