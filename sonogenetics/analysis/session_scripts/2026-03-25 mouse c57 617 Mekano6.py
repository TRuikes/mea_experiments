...
from sonogenetics.analysis.lib.display_tools import raster_per_protocol_master

for i, r in data_io.burst_df.iterrows():
    data_io.burst_df.at[i, 'protocol'] = r.recording_name

raster_per_protocol_master(data_io=data_io, recording_ids=['rec_2_A_20260325_pa_intensity_test'])
