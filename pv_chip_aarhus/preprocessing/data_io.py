...
if __name__ == "__main__":
    ...
    print("Detected sessions:", data_io.sessions)
    print("Loading session:", session_id)

    data_io.load_session(
        session_id,
        load_pickle=False,
        load_waveforms=False
    )

    print("Recording IDs:", data_io.recording_ids)
    print("Number of clusters:", len(data_io.cluster_ids))
    print("Burst DataFrame shape:", data_io.burst_df.shape)
    print("Cluster DataFrame shape:", data_io.cluster_df.shape)
    print("Train DataFrame shape:", data_io.train_df.shape)