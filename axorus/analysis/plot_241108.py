...
for cluster_id, cinfo in data_io.cluster_df.iterrows():
    ...
    waveform_figures.append(sname.as_posix() + '.png')

utils.create_ppt_with_figures_2_row_1_col(waveform_figures, figure_dir / session_id / 'waveforms.pptx')
